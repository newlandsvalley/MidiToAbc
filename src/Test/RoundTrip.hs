...
{-
This hods a few samples where a score is produced, converted back to Music and then played

-}


roundTrip ::  Midi -> AbcContext -> Music1
roundTrip m c = let m1 = fst3 $ fromMidi m
                           in scoreToMusic c $ toAbcScore c $ numberBars $ barline c (condense $ removeZeros m1)
