...
-- this tests the articulate function because the notes on the harp are played slightly staccato
carolansreceipt = 
            do  
                let trackNo = 1
...
-- this sample does note employ any NoteOff messages
galwayHornpipe = 
           do
                let trackNo = 1
